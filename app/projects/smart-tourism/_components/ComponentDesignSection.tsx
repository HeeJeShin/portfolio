            ...
            {[
              ...
              <div key={item.hook} className="bg-gray-50 rounded-lg p-3">
                <div className="flex items-center gap-2 mb-2">
                  <code className="text-sm font-bold text-[#191979]">{item.hook}</code>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={item.store} className="bg-gray-50 rounded-lg p-4">
                <code className="text-sm font-bold text-[#191979]">{item.store}</code>
                <div className="flex items-center gap-2 mt-2">
                  <span className="text-xs bg-blue-100 text-[#191979] px-2 py-0.5 rounded">
