  ...
  return (
    <section className="mb-16">
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200">
        <div className="mb-6">
          <h3 className="font-bold text-[#191979] mb-1">Google Gemini AI 활용</h3>
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="font-bold text-[#191979] mb-1">면적 추정</div>
            <p className="text-xs text-gray-600">
              도면의 스케일과 형태를 분석하여 행사장 면적을 자동 추정
            </p>
          </div>
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="font-bold text-[#191979] mb-1">출입구 감지</div>
            <p className="text-xs text-gray-600">
              비상구 및 출입구 개수를 파악하여 안전 인원 산출에 반영
            </p>
          </div>
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="font-bold text-[#191979] mb-1">부스 개수</div>
            <p className="text-xs text-gray-600">
