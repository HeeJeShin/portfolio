    ...
    <section className="mb-16">
      ...
      <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h3 className="font-bold text-gray-900 mb-1">Google Gemini AI 활용</h3>
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg p-4 border border-blue-100">
            ...
            <div className="font-bold text-gray-900 mb-1">면적 추정</div>
          ...
          <div className="bg-white rounded-lg p-4 border border-blue-100">
            <div className="text-2xl mb-2">🚪</div>
            <div className="font-bold text-gray-900 mb-1">출입구 감지</div>
            <p className="text-xs text-gray-600">
          ...
          <div className="bg-white rounded-lg p-4 border border-blue-100">
            <div className="text-2xl mb-2">🎪</div>
            <div className="font-bold text-gray-900 mb-1">부스 개수</div>
            <p className="text-xs text-gray-600">
