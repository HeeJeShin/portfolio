const sections = [
  ...
  {
    title: "주도하고, 설득하고, 함께 키웁니다",
    content: [
      {
        text: '4년간 가장 크게 달라진 건, "주어진 일을 하는 사람"에서 "방향을 먼저 제안하는 사람"이 된 것입니다.',
        highlight: true,
      },
      {
        text: "저는 목소리가 큰 편은 아닙니다. 신중하게 살피고, 근거가 모이면 그때 움직입니다. 대신 한번 필요하다고 판단하면 끝까지 설득합니다.",
      },
      {
        text: '스마트관광에서 결제 정합성 문제를 만났을 때, 프론트엔드에서 방어 코드로 막는 대신 "결제 완료 처리는 백엔드가 맡아야 한다"는 구조 변경을 제안했습니다. 처음엔 백엔드 팀이 부담스러워했지만, 네트워크가 끊기는 상황을 구체적인 케이스로 정리해 보여주며 설득했고, 결국 구조를 바꿔 문제를 근본적으로 해결했습니다.',
      },
      {
        text: "디자이너가 없던 어드민 프로젝트에서는 제가 먼저 UI 가이드를 만들어 기준을 세우고, 사업부서와 그 화면으로 대화하며 방향을 잡았습니다. 마이그레이션도 1차에 실패했지만, 원인을 회고해 2차를 주도하며 LCP 60% 개선까지 끌어냈습니다.",
      },
      {
        text: "그리고 혼자 잘하는 것보다, 옆 사람이 같이 잘하게 만드는 데 보람을 느낍니다. 인턴과 후배에게 디버깅하는 방법과 코드를 읽는 기준을 알려주고, 윗선과 팀 사이에서 요구사항을 정리해 전달하는 역할을 자연스럽게 맡아왔습니다.",
      },
      {
        text: "큰 목소리로 주장하기보다, 근거와 화면으로 설득하는 주도. 이것이 제가 4년간 만들어온 일하는 방식입니다.",
        highlight: true,
      },
    ],
  },
